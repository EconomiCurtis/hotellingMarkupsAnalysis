...
reg_all = lm(
  player.price ~ factor(group_size) + player.mc+player.rp +player.transport_cost + factor(group_size):player.transport_cost+ factor(group_size):player.rp+factor(group_size):player.mc+factor(player.period_number) +factor(session.code)-1,
  data = AllReg 
)
